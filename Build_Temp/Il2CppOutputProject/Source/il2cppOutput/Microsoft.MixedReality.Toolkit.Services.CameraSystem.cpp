...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MixedRealityPlayspace_set_Rotation_m9545D7307A9C8D0F78BEE34DC85C34BDD3A1C987 (Quaternion_t6D28618CF65156D4A0AD747370DDFD0C514A31B4  ___value0, const RuntimeMethod* method);
...
IL_0059:
	{
		...
		bool L_15;
		L_15 = Type_op_Equality_mA438719A1FDF103C7BBBB08AEF564E7FAEEA0046(G_B6_0, (Type_t *)NULL, /*hidden argument*/NULL);
		if (L_15)
		{
			goto IL_00d3;
		}
...
IL_010b:
	{
		...
		MixedRealityPlayspace_set_Position_m62CD05FC25E8D3E119F82F38140F15730C360BAB(L_41, /*hidden argument*/NULL);
		...
		MixedRealityPlayspace_set_Rotation_m9545D7307A9C8D0F78BEE34DC85C34BDD3A1C987(L_42, /*hidden argument*/NULL);
		// if (CameraCache.Main.transform.position != Vector3.zero)
		Camera_tC44E094BAB53AFC8A014C6F9CFCE11F4FC38006C * L_43;
		L_43 = CameraCache_get_Main_mE8DEF59E43384FA1694CF70F32563A57A5A657CE(/*hidden argument*/NULL);
		NullCheck(L_43);
	...
	}
	{
		...
		L_48 = Vector3_get_zero_m1A8F7993167785F750B6B01762D22C2597C84EF6(/*hidden argument*/NULL);
		...
		String_t* L_51;
		L_51 = String_Format_mB3D38E5238C3164DB4D7D29339D9E225A4496D17(_stringLiteral4FF56F0DB79ED48F92A89FC9BCCE0794BDA6075F, L_50, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(Debug_tEB68BCBEB8EFD60F8043C67146DC05E7F50F374B_il2cpp_TypeInfo_var);
...
IL_0153:
	{
		...
		L_52 = CameraCache_get_Main_mE8DEF59E43384FA1694CF70F32563A57A5A657CE(/*hidden argument*/NULL);
		NullCheck(L_52);
...
IL_000e:
	...
	{ // begin try (depth: 1)
		...
		L_2 = CameraCache_get_Main_mE8DEF59E43384FA1694CF70F32563A57A5A657CE(/*hidden argument*/NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MixedRealityCameraSystem__cctor_mAA56FA18018B43E07283C59F8325BC58679B9267 (const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
